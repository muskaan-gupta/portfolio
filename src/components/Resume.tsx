      ...
      <div className="mt-12 flex flex-col items-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between mb-6 w-full max-w-4xl">
          ...
          <div className="flex gap-4">
            <a 
              href="https://drive.google.com/file/d/1D8n57PXm3UjrSL5twkFyzdy5rp0Zp9hw/view?usp=sharing" 
              target="_blank" 
        ...
        >
          <div className="aspect-[7.5/11] w-full h-full">
            <iframe
              src="https://drive.google.com/file/d/1D8n57PXm3UjrSL5twkFyzdy5rp0Zp9hw/preview"
